    ...
    <head>
        ...
        <body>
            <?php
                ...
                {
                    echo "<script>
                                alert('Não há produtos com baixo nível em estoque!');
                ...
                //Capturar todas as informações e mostra-las através desse foreach
                            ...
                            <div style="page-break-inside: avoid">
                                <table class="table table-bordered">
                                    <tr>
                                        <td colspan="3" align="center"><img src="dist/img/credit/mastercard.png" align="left"/>Relatório de pedido de compra</td>
                                    </tr>
                                </table>
                            </div>';
                    foreach ($mostrar as $mostrando) 
                    {
                                ...
                                <div style="page-break-inside: avoid">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>Tel.Fornecedor</td>
                                            <td>'.$mostrando['cd_telefone']; echo '</td>
                                        </tr>
