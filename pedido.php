    ...
    <body class="skin-red fixed sidebar-mini">
		...
		overflow: auto;">
            ...
            <div class="content-wrapper hidden-sm">
                ...
                <!-- Main content -->
<form method="POST" action="relatorioPedido.php">
                ...
                <section class="content">
                    ...
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title">Registro de produtos com baixo nível em estoque</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <table id="tb_produtos" role="grid" aria-describedby="example1_info" class="table table-condensed table-hover">
                                    <tbody>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="tb_entrada" rowspan="1" colspan="1" style="width: 180px;">Tel. fornecedor</th>
                                                                        ...
                                                                        inner join tb_categoria
                                                                            on tb_produto.cd_categoria = tb_categoria.cd_categoria
                                                                                inner join tb_fornecedor
                                                                                    on tb_produto.cd_fornecedor = tb_fornecedor.cd_fornecedor", "where qt_produto<=10 order by cd_prod_estoque");
                                            if(!$entrada)
                                                echo 'Não há produtos com baixo nível em estoque.';
